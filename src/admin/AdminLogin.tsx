...
export function AdminLogin() {
  ...
  const [email, setEmail] = useState('admin@autozap.com');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-indigo-500/10 backdrop-blur rounded-2xl mb-4">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl p-8 space-y-5">
          ...
          {error && <div className="bg-rose-50 text-rose-600 text-sm px-4 py-3 rounded-xl border border-rose-100">{error}</div>}
          <div>
          ...
          <div className="text-center text-xs text-slate-400 mt-4">
            <p>Demo: <strong>admin@autozap.com</strong> / <strong>admin123</strong></p>
          </div>
        </form>
      </div>
    </div>
